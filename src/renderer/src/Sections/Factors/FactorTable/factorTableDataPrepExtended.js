...
const factorTableEigenDataPrep = (
  ...
  eigenValues,
  lArray,
  largestCorrelationArray,
  largestFactorLoadingArray
) => {
  ...
  factorState.setState({ gridColDefsFacTableEigen: gridColDefsFacTableEigen });
  factorState.setState({ gridRowDataFacTableEigen: gridRowDataFacTableEigen });
};
