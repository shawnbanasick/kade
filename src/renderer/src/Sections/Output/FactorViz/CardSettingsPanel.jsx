...
const CardSettingsPanel = () => {
  ...
  return (
    <div style={{ marginTop: 30 }}>
      ...
      <OptionStatementRow>
        <OptionStatementText>{`5. ${t('Adjust card height')}?`}</OptionStatementText>
        <UserSelectionSwitch
      ...
      <OptionStatementRow>
        <OptionStatementText>{`6. ${t('Adjust card width')}?`}</OptionStatementText>
        <UserSelectionSwitch
      ...
      <OptionStatementRow>
        <OptionStatementText>{`7. ${t('Adjust font size')}?`}</OptionStatementText>
        <UserSelectionSwitch
