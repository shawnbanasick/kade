...
const StatementsSettingsPanel = () => {
  ...
  return (
    <div style={{ marginTop: 30 }}>
      <span style={{ fontSize: 22, userSelect: 'none' }}>{t('Statements')}</span>
      <hr style={{ width: '100%', marginBottom: 15 }} />
      <OptionStatementRow>
        <OptionStatementText>{`8. ${t('Adjust line spacing')}?`}</OptionStatementText>
        <UserSelectionSwitch
      ...
      <OptionStatementRow>
        <OptionStatementText>{`9. ${t('Adjust top margin')}?`}</OptionStatementText>
        <UserSelectionSwitch
      ...
      <OptionStatementRow>
        <OptionStatementText>{`11. ${t('Adjust statement width')}?`}</OptionStatementText>
        <UserSelectionSwitch
      ...
      <OptionStatementRow>
        <OptionStatementText>
          {`12. (${t('Asian languages only')}) ${t('Adjust width of statement rows')}?`}
        </OptionStatementText>
        <UserSelectionSwitch
