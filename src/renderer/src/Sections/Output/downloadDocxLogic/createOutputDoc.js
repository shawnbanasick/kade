...
const generateOutputDoc = translatedTextObj => {
  ...
  data.forEach((item, index) => {
    ...
    if (
      ...
      let text4 = generateUnrotFacMatrix(
        item,
        outputState.willUseHyperlinks,
        outputState.useZebra
      );
