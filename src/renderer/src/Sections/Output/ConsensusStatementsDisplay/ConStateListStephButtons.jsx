...
const DistStateListButtons = () => {
  const stephensonsThreshold = outputState((state) => state.stephensonsThreshold);
  const updateStephensonsThreshold = outputState((state) => state.updateStephensonsThreshold);
