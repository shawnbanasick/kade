...
const Heatmap = ({
  ...
  return (
    <div className="">
      ...
      <button
        onClick={downloadSVG}
        className="mt-4 ml-30! mb-[50px]! px-4 py-2 cursor-pointer bg-grey-button text-black rounded-md hover:bg-grey-button-hover transition-colors flex items-center gap-2"
      >
