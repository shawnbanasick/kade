...
const vizState = create((set) => ({
  ...
  updateWillAdjustStatementWidthBy: (inputValue) => set({ willAdjustStatementWidthBy: inputValue }),
  ...
  updateWillDisplayConsensusStates: (inputValue) => set({ willDisplayConsensusStates: inputValue }),
  ...
  updateWillIndicateDistinguishing: (inputValue) => set({ willIndicateDistinguishing: inputValue }),
