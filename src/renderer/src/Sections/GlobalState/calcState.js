...
const calcState = create(
  immer((set) => ({
    ...
    updateCompositeFactorMasterArray: (inputValue) =>
      set({ compositeFactorMasterArray: inputValue }),
    ...
    updateFactorCharacteristicsArray: (inputValue) =>
      set({ factorCharacteristicsArray: inputValue }),
    ...
    updateMiniCorrelationArrayHolder: (inputValue) =>
      set({ miniCorrelationArrayHolder: inputValue }),
