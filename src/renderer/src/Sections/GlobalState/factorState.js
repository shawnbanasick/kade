...
const factorState = create((set) => ({
  ...
  updateActiveCentroidRevealButton: (inputValue) => set({ activeCentroidRevealButton: inputValue }),
  ...
  updateShowUseHorstIterationSetup: (inputValue) => set({ showUseHorstIterationSetup: inputValue }),
