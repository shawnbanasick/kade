...
const inputState = create(
  immer((set, get) => ({
    ...
    updateIsLoadCsvQsortsButtonGreen: (inputValue) =>
      set({ isLoadCsvQsortsButtonGreen: inputValue }),
    ...
    updateIsLoadSheetsCsvButtonGreen: (inputValue) =>
      set({ isLoadSheetsCsvButtonGreen: inputValue }),
    ...
    updateIsLoadBuzzwordsButtonGreen: (inputValue) =>
      set({ isLoadBuzzwordsButtonGreen: inputValue }),
