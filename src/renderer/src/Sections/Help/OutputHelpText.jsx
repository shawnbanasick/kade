...
const HelpSection = () => {
  return (
    <>
      <div className="select-all bg-white p-[50px] pb-[150px] overflow-auto">
        ...
        <ul>
          <li>
            <p>
              ...
              statement is distinguishing at P &lt; .05. Two asterisks indicate that the statement
              is distinguishing at P &lt; .01.
            </p>
          </li>
          <li>
            <p>
              <strong>
                On the composite factor visualizations, what are those black triangles?
              </strong>{' '}
        ...
        <p>
          ...
          &quot;<strong>DOCX File</strong>&quot; button to download the results of the analysis. The
          XLSX and CSV buttons will open a download dialog box.{' '}
        </p>
        ...
        <p>
          Click the <strong>&quot;Factors Table&quot;</strong> tab to view the statement Z-scores
          and rankings for each factor.
        </p>
        ...
        <p>
          ...
          <strong>&quot;Update Factor Visualizations&quot;</strong> button to apply the changes to
          the visualizations.
        </p>
