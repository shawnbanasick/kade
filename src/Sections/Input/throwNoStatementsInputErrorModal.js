...
export default function throwNoStatementsInputErrorModal(message) {
  ...
  if (message) {
    ...
    errorMessage = i18n.t("Cant find any statements on the statements tab in the Excel File");
  }
  // catch input error
  inputState.showErrorMessageBar = true;
  inputState.errorMessage = errorMessage;
  inputState.extendedErrorMessage = i18n.t("Check the format of the file and try again");
