    ...
    render() {
        ...
        return (
            <FactorSelectModalDiv>
              <Modal trigger={ <Button id="factorsKeptSubmitButton" size={ "big" } toggle active={ active } disabled={ isFacSelectDisabled } loading={ isLoadingFactorsKept } onClick={ this.handleOpen }>
                                 Submit
                               </Button> } open={ localStore.modalOpen } onClose={ this.handleClose } basic size="small">
