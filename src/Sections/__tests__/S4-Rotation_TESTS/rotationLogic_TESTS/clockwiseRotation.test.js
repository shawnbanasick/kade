import clockwiseRotation from "../../../Rotation/JudgementalRotation/rotationLogic/clockwiseRotation";
...
test("clockwise rotation", () => {
  const value1 = clockwiseRotation(parameter1, parameter2, parameter3);
