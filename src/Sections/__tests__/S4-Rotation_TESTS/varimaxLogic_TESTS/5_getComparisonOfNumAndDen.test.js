...
import getComparisonOfNumAndDen from "../../../Rotation/varimaxLogic/5_getComparisonOfNumAndDen";
...
test("get comparison of num and den - 4", () => {
  const value1 = getComparisonOfNumAndDen(parameter1, parameter2);
...
test("get comparison of num and den - 1", () => {
  const value1 = getComparisonOfNumAndDen(parameter1a, parameter2a);
