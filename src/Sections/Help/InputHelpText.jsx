  ...
  render() {
    return (
      <MainContent>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              <br /> No, the Excel type 3 import will only load the original
              sort data
            </p>
          </li>
        </ul>
        ...
        <p>
          The Excel type files are the most convenient since they bring all of
          the required information into a single file.{" "}
        </p>
        ...
        <p>
          ...
          the q-sorts. Studies using either forced (symmetric) q-sorts or
          unforced q-sorts can use the CSV format. This is the best format for
          long-term archiving of study data.
        </p>
        ...
        <p>
          Easy HTMLQ is a minor change to the HTMLQ project developed by
          aproxima Gesellschaft für Markt- und Sozialforschung Weimar that
          allows the use of the (free) Google Firebase service as the backend
          database.{" "}
          <strong>
            (
        ...
        <p>
          ...
          information (file type *.DAT). Both files are required to bring
          PQMethod data in KADE.{" "}
          <strong>
