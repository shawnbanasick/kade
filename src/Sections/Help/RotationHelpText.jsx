  ...
  render() {
    return (
      <MainContent>
        ...
        <RotationImage />
        <ol>
          <li>For Judgmental rotation, click the <strong>"Judgmental"</strong> tab. Then, click the <strong>"Initialize Judgmental Rotation"</strong> button.</li>
          <li>Then, select the factors to rotate and click <strong>"Display"</strong>.</li>
          <li>Rotate the factor using the preset buttons - 1, 5, 10, or 90 degrees. </li>
          <li>You can also use the user-set button (type the value in text area inside the button). </li>
          <li>When satisfied with the rotation, click the orange <strong>"Save Rotation"</strong> button. This will clear the scatter plot and table from the screen and reset
            the factor selection.</li>
        </ol>
      </MainContent>
      );
  }
