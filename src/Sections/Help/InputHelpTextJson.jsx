...
import JsonInputImage from './helpImages/JsonInputImage';
  ...
  render() {
    return (
      <MainContent>
        ...
        <p>The Q sorts key value must be "sort", and the Q sort values must be a text string with the values separated by bars. (The same style used by HTMLQ and Easy HTMLQ.)</p>
        <JsonInputImage />
