...
class FactorCorrelationsTable extends Component {
    ...
    render() {
        ...
        return (
            <div>
              <div style={ { height: 140, width: widthVal } } className="ag-fresh">
                <AgGridReact columnDefs={ gridColDefsFacCorrTable } rowData={ gridRowDataFacCorrTable } onGridReady={ this.onGridReady.bind(this) } domLayout={ "autoHeight" } enableSorting={ true }
                />
              </div>
            </div>
            );
