...
const formatDistingArrayForDownload = (
  ...
  const chartText2 = `(${distStateLowerValueText} : ${i18n.t("Asterisk Indicates Significance at")} ${distStateUpperValueText})`;
  const chartText3 =
    i18n.t("Both the Factor Q Sort Value and the Z Score Z SCR are Shown");
