      ...
      if (shouldDisplayDistStateListButtons) {
        return (
          <StyledWrapper>
            ...
            <Button id={ "p0001Button" } className="wrapper1" toggle active={ localStore.p0001Active } onClick={ handleOnclick } key={ "f1" }>
                0.0001
            </Button>
            <Button id={ "p001Button" } className="wrapper1" toggle active={ localStore.p001Active } onClick={ handleOnclick } key={ "f2" }>
                0.001
            </Button>
            <Button id={ "p01Button" } className="wrapper1" toggle active={ localStore.p01Active } onClick={ handleOnclick } key={ "f3" }>
               0.01
            </Button>
            <Button id={ "p05Button" } className="wrapper1" toggle active={ localStore.p05Active } onClick={ handleOnclick } key={ "f4" }>
               0.05
            </Button>
            <Button id={ "p1Button" } className="wrapper1" toggle active={ localStore.p1Active } onClick={ handleOnclick } key={ "f5" }>
               0.1
            </Button>
            <Button id={ "p15Button" } className="wrapper1" toggle active={ localStore.p15Active } onClick={ handleOnclick } key={ "f6" }>
               0.15
            </Button>
            <Button id={ "p2Button" } className="wrapper1" toggle active={ localStore.p2Active } onClick={ handleOnclick } key={ "f7" }>
               0.2
            </Button>
