      ...
      if (shouldDisplayDistStateListButtons) {
        return (
          <StyledWrapper>
            ...
            <Button id={ "thresholdButton" } className="wrapper1" toggle active={ localStore.thresholdButtonActive } onClick={ handleOnclick } key={ "f1" }>
                Threshold
            </Button>
            <Button id={ "qSortValueButton" } className="wrapper1" toggle active={ localStore.qSortValueButtonActive } onClick={ handleOnclick } key={ "f2" }>
                Q Sort Value
            </Button>
            <Button id={ "statementNumButton" } className="wrapper1" toggle active={ localStore.statementNumButtonActive } onClick={ handleOnclick } key={ "f3" }>
                Statement Number
            </Button>
          </StyledWrapper>
          );
