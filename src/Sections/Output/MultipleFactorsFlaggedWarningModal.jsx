...
class UnforcedWarningModal extends Component {
    render() {
        ...
        if (showMultipleFactorsFlaggedWarningModal) {
            return (
                <Modal dimmer={ "blurring" } open={ showMultipleFactorsFlaggedWarningModal } onClose={ handleClose }>
                  ...
                  <Modal.Actions>
                    <Button id="multipleFactorsFlaggedWarningModalGotItButton" color="green" style={ { margin: 15 } } floated="right" onClick={ handleClose } inverted>
                      Got it
                    </Button>
                  </Modal.Actions>
                </Modal>
