...
function handleClose() {
  ...
  const btnId = outputState.outputButtonsArray;
...
const UnforcedWarningModal = () => {
  const showMultipleFactorsFlaggedWarningModal =
    outputState.showMultipleFactorsFlaggedWarningModal;
  const sortsFlaggedOnTwoFactors = outputState.sortsFlaggedOnTwoFactors;
