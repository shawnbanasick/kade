...
function addDistinguishingSymbolsToData(
  ...
  const consensus01Statements = clone(calcState.consensus01Statements);
  const consensus05Statements = clone(calcState.consensus05Statements);
  const userSelectedFactors2 = clone(outputState.userSelectedFactors);
