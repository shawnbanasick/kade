...
function getWidth(numFacsForTableWidth) {
  let tableWidth = 310 + 15 + 145 * numFacsForTableWidth;
...
class LoadingsTable extends Component {
  ...
  render() {
    ...
    const autoflagButtonColor = state.getState("autoflagButtonColor");
      ...
      <div>
        <LoadingsContainerDiv>
          ...
          <HighlightingAndFlaggingButtonBar>
            ...
            <StyledWrapperAutoflag buttoncolor={localStore.autoflagButtonColor}>
              <Button
                id="autoflagButton"
                className="wrapper1"
            ...
            </StyledWrapperAutoflag>

            <StyledWrapper>
              <span style={{ marginLeft: 5, marginRight: 10 }}>at</span>
              <SigLevelDropdown data={"allData"} style={{ marginLeft: 5 }} />
              <Button
                className="wrapper1"
...
const StyledWrapperAutoflag = styled.div`
  .wrapper1 {
