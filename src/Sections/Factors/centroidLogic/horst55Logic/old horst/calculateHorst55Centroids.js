...
const HOLDR = [
  [1.0, 0.829, 0.768, 0.108, 0.033, 0.108, 0.298, 0.309, 0.351],
  [0.829, 1.0, 0.775, 0.115, 0.061, 0.125, 0.323, 0.347, 0.369],
  [0.768, 0.775, 1.0, 0.272, 0.205, 0.238, 0.296, 0.271, 0.385],
  [0.108, 0.115, 0.272, 1.0, 0.636, 0.626, 0.249, 0.183, 0.369],
  [0.033, 0.061, 0.205, 0.636, 1.0, 0.709, 0.138, 0.091, 0.254],
  [0.108, 0.125, 0.238, 0.626, 0.709, 1.0, 0.19, 0.103, 0.291],
  [0.298, 0.323, 0.296, 0.249, 0.138, 0.19, 1.0, 0.654, 0.527],
  [0.309, 0.347, 0.271, 0.183, 0.091, 0.103, 0.654, 1.0, 0.541],
  [0.351, 0.369, 0.385, 0.369, 0.254, 0.291, 0.527, 0.541, 1.0]
];
...
const calculateHorst55Centroids = (numFactors, STPCRT, HOLDR) => {
  ...
  do {
    ...
    const diagonals = getDiagonalsAndNewDiagonals(
      D,
      U,
      L,
      NL,
