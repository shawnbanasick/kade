...
const doHeywoodAdjustment = () => {
  ...
  let fMatrix = clone(factorState.heywoodAdjustedMatrix);
  ...
  let projectLogText4;
  const brown = factorState.activeTraditionalCentroidFactorButton;
  const horst = factorState.activeHorst55CentroidButton;
  if (brown) {
  ...
  // const heywoodParticipantsText = factorState.heywoodParticipantsText;
