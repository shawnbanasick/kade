...
const UseHorstAutoStop = () => {
  ...
  // getState
  const showUseHorstLimit = factorState.showUseHorstLimit;
  ...
  const horstAutoStopYesDisabled = factorState.horstAutoStopYesDisabled;
  const horstAutoStopNoActive = factorState.horstAutoStopNoActive;
  const horstAutoStopNoDisabled = factorState.horstAutoStopNoDisabled;
    ...
    return (
      <React.Fragment>
        <HorstLimitContainerDiv>
          <TextSpan>
            {`${t(
              "Use Horst limit to determine the number of factors to extract"
            )}?  `}
          </TextSpan>
          <YesButton
            id={"yes"}
