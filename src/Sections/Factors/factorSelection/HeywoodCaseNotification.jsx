...
const HeywoodCaseNotification = () => {
  ...
  const handleReselectClick = event => {
    ...
    const projectHistoryArray = projectHistoryState.projectHistoryArray;
  ...
  const handleContinueClick = () => {
    const projectHistoryArray = projectHistoryState.projectHistoryArray;
    const heywoodParticipantsTextJoin = factorState.heywoodParticipantsTextJoin;

    const projectLogText3 = `${i18n.t(
      "Heywood Case Participants"
    )}: ${heywoodParticipantsTextJoin}. ${i18n.t(
      "Factor Loadings not adjusted"
    )}.`;
  ...
  const heywoodContinueButtonActive = factorState.heywoodContinueButtonActive;
  const heywoodAdjustButtonActive = factorState.heywoodAdjustButtonActive;
  const heywoodReselectButtonActive = false;
  const heywoodButtonDisabled = factorState.heywoodButtonDisabled;
  const showHeywoodCaseNotifications = factorState.showHeywoodCaseNotifications;
  const heywoodParticipantsCommunalities = clone(
