...
export default class ModalExampleControlled extends Component {
    ...
    render() {
        ...
        return (
            <Modal trigger={ <Button id="noFacSelectedModalButton" size={ "small" } toggle active={ isActive } loading={ isCentroidLoading } disabled={ isDisabled } onClick={ this.handleOpen }>
                   Centroid Factors
