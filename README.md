...
The Netlify data importer is broken. Until I can fix it, this [guide]("https://github.com/shawnbanasick/kade/blob/778c080ac2c59925bda40f0162a568eb3c9f41c9/resources/Netlify%20data%20to%20Excel.pdf") will show how to parse the Netlify data in MS Excel. After parsing the data, copy and paste the participant names ad Q sort data into the Type 2 Excel worksheet import format to load the data into KADE.
